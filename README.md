...
**WARNING:** Previous versions of this MOD use another built-in names. If you're upgrading, you'll need to update your shaders.
...
This Godot fork has a new "processor function" for spatial shaders called **lightready()** with access to **AMBIENT_VAL**, **DIFFUSE_VAL**, **DIRECT_SPECULAR_VAL**, **INDIRECT_SPECULAR_VAL** and **ALPHA** built-ins. So you can do a godot shader like this:
