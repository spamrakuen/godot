...
**WARNING:** Previous versions of this MOD use LIGHT instead of VAL in built-in names. If you're updaring, you'll need to update your shaders.
...
This Godot fork has a new "processor function" for spatial shaders called **lightready()** with access to **AMBIENT_VAL**, **DIFFUSE_VAL**, **SPECULAR_VAL** and **ALPHA** built-ins. So you can do a godot shader like this:
	...
	void lightready() {
		...
		SPECULAR_VAL *= vec3(0.0, 0.0, 1.0);	
	}

**WARNING:** Only direct specular light is used.
